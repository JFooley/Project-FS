...
public class WGSelectStage : Widget {
    ...
    public override void Render() {
        ...
        if (UI.DrawButton(Language.GetText(Data.stages[pointer].name), 0, -95, spacing: Config.spacing_medium, click: Input.Key_hold("A"), action: Input.Key_up("A"), click_font: "default medium click", hover_font: "default medium white")) {
